...
<head>
    ...
    <title>MUNYESHURI INFORMMATION MANAGEMENT SOFTWARE SYSTEM </title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: #04AA6D">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp;  Teacher Panel</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color: #04AA6D">
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: #04AA6D">
            <?php 
            // include 'db.php';
...
?>
    ...
    ?>
      ...
      <div class="col-sm-3">  
              <input type="hidden" class="form-control" name="id" value="BN,,,MMNBVCCVVBN" >
