    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="active"><a href="./teachallmarks.php">All Marks <span><i class="fa fa-lock"></i></span></a></li>
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="clearfix">
                            <div class="title-area pull-left">
                                <h2>ADD STUDENT MARKS<small></small></h2>
                            </div>
                            <!-- /.pull-right -->
            ...
            <div class="section">
                <div class="container-fluid">
                    <form class="defaultform row"  action="./php/regstudent.php" method="GET" enctype="multipart/form-data">
                        <div class="col-md-12">
...
<tr style="text-align:center;">
                      ...
                      <td><?php echo $row["Orgins"];?></td>
                      
                      <td><img src="./uploads/<?php echo $row['image'];?>". style ="width:100px;height:75px;"> </td>
                         <td><a href="addstudentmark.php?STUD_ID=<?php echo $row["STUD_ID"];?>" class="btn btn-info mr-3y">Register Mark</td>
                 					</tr>
										<?php }} ?>
